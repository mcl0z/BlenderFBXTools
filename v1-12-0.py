# -*- coding: utf-8 -*-
# Auto-generated by build_singlefile_addon.py. Do not edit this file directly.
...
bl_info = {
    ...
    "description": "有BUG请反馈 mcl0@qq.com",
    "warning": "",
    "doc_url": "",
    "category": "Animation",
}
...
class ANIM_OT_ImportActionFromJSON(bpy.types.Operator):
    ...
    def invoke(self, context, event):
        context.window_manager.fileselect_add(self)
        return {'RUNNING_MODAL'}
# ===== END: ops_merge_library.py =====

# ===== BEGIN: ops_bone_tools.py =====
...
# ===== END: ops_bone_tools.py =====

# ===== BEGIN: ops_orientation_library.py =====
def _refresh_library_view(context, target_filepath=None, target_name=None):
    load_library_actions()
    props = context.scene.anim_merge_props
    props.show_library = True
...
# ===== END: ops_orientation_library.py =====
...
# ===== END: path_animation.py =====

# ===== BEGIN: breath_animation.py =====
...
# ===== END: breath_animation.py =====

# ===== BEGIN: camera_animation.py =====
    ...
    if not _startup_timer_registered:
        ...
        def check_updates_on_startup():
            if not bpy.context.window_manager.progress_begin:
                if (
                    hasattr(bpy.context.scene, "anim_merge_props")
                    and bpy.context.scene.anim_merge_props.auto_check_update
                ):
